 ...
 * - Schemas
 */
var _ApiService = exports._ApiService = /*#__PURE__*/function () {
  function _ApiService() {
    _classCallCheck(this, _ApiService);
    _defineProperty(this, "last_count", void 0);
  ...
  _createClass(_ApiService, [{
    ...
    key: "fetch",
    value: function () {
      var _fetch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(route) {
        var body,
          result,
          environment,
          response,
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              _context2.next = 7;
              return _jqueryLib.$.get({
                url: (environment === null || environment === void 0 ? void 0 : environment.backend_url) + route,
                dataType: 'json',
                data: body,
    ...
    key: "create",
    value: function () {
      var _create = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(entity) {
        var fields,
          result,
          environment,
          params,
    ...
    key: "read",
    value: function () {
      var _read = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(entity, ids, fields) {
    ...
    key: "delete",
    value: function () {
      var _delete2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(entity, ids) {
        var permanent,
          result,
          environment,
          params,
    ...
    key: "archive",
    value: function () {
      var _archive = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(entity, ids) {
        var result, environment, params, response;
    ...
    key: "update",
    value: (function () {
      var _update = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(entity, ids, fields) {
        var force,
          result,
          environment,
          params,
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              force = _args7.length > 3 && _args7[3] !== undefined ? _args7[3] : false;
    ...
    key: "clone",
    value: function () {
      var _clone = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(entity, ids) {
        var result, environment, params, response;
    ...
    key: "collect",
    value: (function () {
      var _collect = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(entity, domain, fields, order, sort, start, limit, lang) {
        var _this = this;
    ...
    key: "search",
    value: (function () {
      var _search = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(entity, domain, order, sort, start, limit) {
        var result, params, environment, response;
...
var _default = exports["default"] = _ApiService;

/***/ }),

/***/ "./build/Chapter.class.js":
/*!********************************!*\
  !*** ./build/Chapter.class.js ***!
  \********************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
 ...
 *
 */
var ChapterClass = exports.ChapterClass = /*#__PURE__*/function () {
  function ChapterClass() {
    ...
    var pages = arguments.length > 4 ? arguments[4] : undefined;
    _classCallCheck(this, ChapterClass);
        ...
        */
        ...
        $chapter_add_button.on('click', function () {
          ...
          window.eq.popup({
            ...
            mode: 'edit',
            purpose: 'create',
            domain: [['chapter_id', '=', _this.id], ['identifier', '=', page_identifier], ['order', '=', page_identifier]],
            callback: function callback(data) {
...
var _default = exports["default"] = ChapterClass;

/***/ }),

/***/ "./build/ContextService.js":
/*!*********************************!*\
  !*** ./build/ContextService.js ***!
  \*********************************/
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == typeof i ? i : String(i); }
function _toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var _ContextService = exports._ContextService = /*#__PURE__*/function () {
  function _ContextService() {
    _classCallCheck(this, _ContextService);
    _defineProperty(this, "module_id", 1);
    // module identifier (id field)
    _defineProperty(this, "chapter_index", 0);
    _defineProperty(this, "page_index", 0);
    _defineProperty(this, "mode", 'view');
    _defineProperty(this, "user_allowed", true);
...
var _default = exports["default"] = _ContextService;

/***/ }),

/***/ "./build/Domain.class.js":
/*!*******************************!*\
  !*** ./build/Domain.class.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, exports) => {
...
exports["default"] = exports.DomainClass = exports.Condition = exports.Clause = void 0;
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
 ...
 *
 */
var DomainClass = exports.DomainClass = /*#__PURE__*/function () {
  function DomainClass(domain) {
    _classCallCheck(this, DomainClass);
    _defineProperty(this, "clauses", void 0);
    this.clauses = new Array();
    this.fromArray(domain);
  }
  _createClass(DomainClass, [{
    key: "fromArray",
...
var Clause = exports.Clause = /*#__PURE__*/function () {
  function Clause() {
...
var Condition = exports.Condition = /*#__PURE__*/function () {
  function Condition(operand, operator, value) {
    ...
    _defineProperty(this, "operand", void 0);
...
var _default = exports["default"] = DomainClass;
 ...
 */
var _EnvService = exports._EnvService = /*#__PURE__*/function () {
  function _EnvService() {
    _classCallCheck(this, _EnvService);
...
var _default = exports["default"] = _EnvService;

/***/ }),

/***/ "./build/Group.class.js":
/*!******************************!*\
  !*** ./build/Group.class.js ***!
  \******************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
 ...
 *
 */
var GroupClass = exports.GroupClass = /*#__PURE__*/function () {
  ...
  widgets, visible) {
    ...
    // 'horizontal' (widgets are displayed inline), 'vertical' (widgets stacked one on the other)
    _defineProperty(this, "row_span", void 0);
    // (default = 1, max = 6)
    _defineProperty(this, "fixed", void 0);
    // (if true, must remain always visible)
    _defineProperty(this, "widgets", void 0);
  ...
  _createClass(GroupClass, [{
      ...
      if (context.mode == 'view') {
        ...
        $add_button.on('click', function () {
          ...
          window.eq.popup({
            ...
            mode: 'edit',
            purpose: 'create',
            domain: [['group_id', '=', _this.id], ['identifier', '=', widget_identifier], ['order', '=', widget_identifier]],
            callback: function callback(data) {
        ...
        $move_up_button.on('click', function () {
          _this.parent.propagateContextChange({
            '$leaf.move_group_up': _this.id,
            refresh: true
          });
        });
        $move_down_button.on('click', function () {
          _this.parent.propagateContextChange({
            '$leaf.move_group_down': _this.id,
            refresh: true
          });
        });
    ...
    key: "onContextChange",
    value: function onContextChange(contextChange) {
      console.info('Group::onContextChange', contextChange);
...
var _default = exports["default"] = GroupClass;
 ...
 *
 */
var LeafClass = exports.LeafClass = /*#__PURE__*/function () {
  function LeafClass() {
    var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    var identifier = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
    ...
    _classCallCheck(this, LeafClass);
    _defineProperty(this, "id", void 0);
    _defineProperty(this, "identifier", void 0);
    _defineProperty(this, "order", void 0);
    ...
    _defineProperty(this, "visible", void 0);
    // (ex. [ '$submitted', ''=',' true ] ; [ '$selected', ''=', 2])
    _defineProperty(this, "background_image", void 0);
    // image URL
    _defineProperty(this, "background_opacity", void 0);
    // float
    _defineProperty(this, "background_stretch", void 0);
    ...
    value: function render() {
      ...
      if (this.groups && this.groups.length) {
        ...
        for (var index in this.groups) {
          ...
          var group = new _Group.GroupClass(item.id, item.identifier, item.order, item.direction, item.row_span, item.fixed, item.widgets, item.visible);
      ...
      if (context.mode == 'view') {
        ...
        $add_button.on('click', function () {
          ...
          window.eq.popup({
            ...
            mode: 'edit',
            purpose: 'create',
            domain: [['leaf_id', '=', _this.id], ['identifier', '=', group_identifier], ['order', '=', group_identifier]],
            callback: function callback(data) {
              // append new page to chapter
              if (data && data.objects) {
                var _iterator2 = _createForOfIteratorHelper(data.objects),
...
var _default = exports["default"] = LeafClass;
 ...
 *
 */
var ModuleClass = exports.ModuleClass = /*#__PURE__*/function () {
  function ModuleClass() {
    ...
    var duration = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 0;
    var chapters = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : [];
    _classCallCheck(this, ModuleClass);
    _defineProperty(this, "id", void 0);
    _defineProperty(this, "identifier", void 0);
    _defineProperty(this, "order", void 0);
    _defineProperty(this, "name", void 0);
    // (ex. Module 1, Insider Threat)
    _defineProperty(this, "title", void 0);
  ...
  _createClass(ModuleClass, [{
    ...
    value: function init() {
      ...
      if (this.context.mode == 'view') {
        ...
        */
        ...
        $module_edit_button.on('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          var environment;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
        ...
        $module_add_button.on('click', function () {
          ...
          window.eq.popup({
            ...
            mode: 'edit',
            purpose: 'create',
            domain: [['module_id', '=', _this.id], ['identifier', '=', chapter_identifier], ['order', '=', chapter_identifier]],
            callback: function callback(data) {
      ...
      if (this.context.mode == 'view') {
        ...
        (0, _jqueryLib.$)('body').append($btnup).append($btndown);
      }
    }
  }, {
    key: "propagateContextChange",
    ...
    value: function onContextChange(contextChange) {
      // update contextChange object with instance context
      for (var _i3 = 0, _Object$keys3 = Object.keys(this.context); _i3 < _Object$keys3.length; _i3++) {
        var elem = _Object$keys3[_i3];
...
var _default = exports["default"] = ModuleClass;
 ...
 * 
 */
var PackClass = exports.PackClass = /*#__PURE__*/_createClass(function PackClass(id, name,
// (ex. PDT, AT)
subtitle,
...
description) {
  _classCallCheck(this, PackClass);
  _defineProperty(this, "id", void 0);
  _defineProperty(this, "name", void 0);
  // (ex. PDT, AT)
...
var _default = exports["default"] = PackClass;
 ...
 *
 */
var PageClass = exports.PageClass = /*#__PURE__*/function () {
  function PageClass() {
    var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    var identifier = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
    var order = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
    ...
    //'basic',  'chapter_select'
    _defineProperty(this, "next_active", void 0);
    // domain
    _defineProperty(this, "sections", void 0);
    _defineProperty(this, "selection", void 0);
    // selected section_id
    _defineProperty(this, "section_id", 0);
    _defineProperty(this, "$container", void 0);
    _defineProperty(this, "parent", void 0);
  ...
  _createClass(PageClass, [{
    ...
    value: function render(context) {
      ...
      if (this.sections && this.sections.length) {
        ...
        for (var _index in this.sections) {
          var _item = this.sections[_index];
          var section = new _Section.SectionClass(_item.id, _item.identifier, _item.order, _item.pages);
          this.sections[_index] = section;
        ...
        */
        ...
        $page_add_button.on('click', function () {
          ...
          window.eq.popup({
            ...
            mode: 'edit',
            purpose: 'create',
            domain: [['page_id', '=', _this.id], ['identifier', '=', leaf_identifier], ['order', '=', leaf_identifier]],
            callback: function callback(data) {
              // append new page to chapter
              if (data && data.objects) {
                var _iterator2 = _createForOfIteratorHelper(data.objects),
        ...
        $page_add_sect_button.on('click', function () {
          window.eq.popup({
            ...
            mode: 'edit',
            purpose: 'create',
            domain: [['page_id', '=', _this.id], ['identifier', '=', _this.sections.length + 1]],
            callback: function callback(data) {
              // append new page to chapter
              if (data && data.objects) {
    ...
    key: "openSection",
    value: function openSection(section_id, context) {
      ...
      if (section) {
        ...
        setTimeout(function () {
          (0, _jqueryLib.$)('body').find('.section-nav-down').trigger('click');
        }, 100);
      }
    }
  }, {
...
var _default = exports["default"] = PageClass;
 ...
 *
 */
var SectionClass = exports.SectionClass = /*#__PURE__*/function () {
  function SectionClass(id, identifier, order, pages) {
  ...
  _createClass(SectionClass, [{
    ...
    key: "getContainer",
    value: function getContainer(page_id) {
      return (0, _jqueryLib.$)('body').find('.section-page-container.viewport-container.page-id_' + page_id);
    }
  }, {
    key: "setContext",
    value: function setContext(context) {
        ...
        */
        ...
        $add_button.on('click', function () {
          ...
          window.eq.popup({
            ...
            mode: 'edit',
            purpose: 'create',
            domain: [['section_id', '=', _this.id], ['identifier', '=', page_identifier], ['order', '=', page_identifier]],
            callback: function callback(data) {
...
var _default = exports["default"] = SectionClass;

/***/ }),

/***/ "./build/TextRenderer.class.js":
/*!*************************************!*\
  !*** ./build/TextRenderer.class.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, exports) => {
 ...
 *
 */
var TextRendererClass = exports.TextRendererClass = /*#__PURE__*/function () {
  function TextRendererClass() {
    _classCallCheck(this, TextRendererClass);
  }
  _createClass(TextRendererClass, null, [{
    key: "render",
...
var _default = exports["default"] = TextRendererClass;

/***/ }),

/***/ "./build/Widget.class.js":
/*!*******************************!*\
  !*** ./build/Widget.class.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
 ...
 *
 */
var WidgetClass = exports.WidgetClass = /*#__PURE__*/function () {
  function WidgetClass(id, identifier, order, type, has_separator_left, has_separator_right, align, on_click, section_id, content, sound_url, video_url, image_url) {
    ...
    */
    _defineProperty(this, "has_separator_left", void 0);
    // (2px at bottom left of widget)
    _defineProperty(this, "has_separator_right", void 0);
    // (2px at bottom right of widget)
    _defineProperty(this, "align", void 0);
    // 'left' or 'right'
    _defineProperty(this, "on_click", void 0);
    /*
    function
    ...
    */
    _defineProperty(this, "section_id", void 0);
    // (id of section within parent page sections array)
    _defineProperty(this, "content", void 0);
    // text (with MD support)
    _defineProperty(this, "sound_url", void 0);
    _defineProperty(this, "video_url", void 0);
    _defineProperty(this, "image_url", void 0);
    _defineProperty(this, "selected", void 0);
    _defineProperty(this, "parent", null);
    _defineProperty(this, "$container", void 0);
    _defineProperty(this, "previously_selected", false);
    _defineProperty(this, "context", {
      mode: 'view'
    });
    this.id = id;
      ...
      switch (this.type) {
        ...
        case 'selector_section_wide':
          this.$container.on('click', function () {
            ...
            _this.parent.getParent().getParent().openSection(_this.section_id, context);
          });
          break;
      }
      if (context.mode == 'edit') {
        ...
        $edit_button.on('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          var environment;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
...
var _default = exports["default"] = WidgetClass;
...
exports.EnvService = exports.ContextService = exports.ApiService = void 0;
 ...
 * Singleton instances
 */
var ApiService = exports.ApiService = new _ApiService2.default();
var EnvService = exports.EnvService = new _EnvService2.default();
var ContextService = exports.ContextService = new _ContextService2.default();
