        ...
        if (context.mode == 'edit') {
            ...
            */
            ...
            $chapter_edit_button.on('click', () => {
                window.eq.popup({
                    entity: 'qursus\\Chapter', type: 'form', mode: 'edit', domain: ['id', '=', this.id], callback: (data: any) => {
            ...
            $chapter_add_button.on('click', () => {
                ...
                window.eq.popup({
                    entity: 'qursus\\Page', type: 'form', name: 'create', mode: 'edit', purpose: 'create', domain: [['chapter_id', '=', this.id], ['identifier', '=', page_identifier], ['order', '=', page_identifier]], callback: (data: any) => {
